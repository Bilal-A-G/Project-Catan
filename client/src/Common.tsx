...
//Get an axial offset (q, r) based on the index the vertex was created at, ie, 0 denotes the left most vertex
...
export function VertexScreenToAxial(screen : Vector2, spacing : Vector2, offset : Vector2, i : number){
    ...
    return centerHexAxial;// new Vector2(centerHexAxial.x + axialOffset.x, centerHexAxial.y + axialOffset.y);
}
